% Portable preprint rendering of the Physical Review B manuscript v06.
% The submission source is modular_flux_PRB_v06.tex and uses REVTeX 4.2.
...
\newcommand{\affiliation}[1]{\\[0.25em]{\small #1}}
...
\input{unicyclic_proof_section}

\input{cycle_axial_sections}
...
The source code and exact-arithmetic certificates supporting this study are
available in the accompanying GitHub repository at
\url{https://github.com/JeromeNicolas2026/thermal-modular-commutators}.
The repository version used for this article is archived on Zenodo under DOI
\href{https://doi.org/10.5281/zenodo.22860690}{10.5281/zenodo.22860690}.
The archive includes
\path{SHA256SUMS_v06.txt}, which records SHA-256 checksums for the deposited
files.  No additional data were generated.
